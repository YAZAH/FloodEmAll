        ...
        public void onUnityAdsPlacementStateChanged(String placement, UnityAds.PlacementState oldState, UnityAds.PlacementState newState) {
            ...
            if (!mHasInitialised) {
                ...
                if(newState == UnityAds.PlacementState.READY) {
                    ...
                    if (mActivity != null)
                        new TMStatsManager(mActivity).sendDidLoad(mActivity, getName(), isPublisherKeys(), TMAdType.getString(mType), mPlacement, getVersionID(mActivity));
                    ...
                    if (mActivity != null)
                        new TMStatsManager(mActivity).sendDidFailToLoad(mActivity, getName(), isPublisherKeys(), TMAdType.getString(mType), mPlacement, getVersionID(mActivity), placement);
                    mActivity = null;
                    mListener = null;
                }
            }
